...
/** Sustituye la URL en `.env` con `NEXT_PUBLIC_PACKS_YOUTUBE_EMBED=https://www.youtube.com/embed/TU_VIDEO_ID?...` cuando tengas el enlace definitivo. */
const DEFAULT_PACKS_VIDEO_EMBED =
  "https://www.youtube.com/embed/CxC8gIuPOOA?rel=0&modestbranding=1&controls=0";

const LINEAMIENTO_BOXES = [
  {
...
const DulcesDieciseis = () => {
  ...
  const videoEmbedSrc = useMemo(
    () => process.env.NEXT_PUBLIC_PACKS_YOUTUBE_EMBED ?? DEFAULT_PACKS_VIDEO_EMBED,
    []
  );
  ...
  return (
    <Box sx={{ bgcolor: "#F8F8F8", minHeight: "100vh", color: "#333", pb: { xs: 6, sm: 0 } }}>
        ...
        <Container>
          ...
          <Box sx={{ display: "flex", justifyContent: "center", mb: 3 }}>
            <iframe
              ...
              height="203"
              src={videoEmbedSrc}
              title="Ecopipo — paquetes especiales"
              frameBorder="0"
          ...
          <Typography
            variant="body1"
            sx={{ fontWeight: 400, color: "#444", marginTop: 2, maxWidth: 560, mx: "auto" }}
          >
            Con estos packs pre elaborados tendrás todo lo que necesitas para empezar. Elige el tuyo,
            selecciona los modelos y listo.
          </Typography>
          <Box sx={{ textAlign: "center", marginTop: 2 }}>
            <Button
              component={Link}
              href="/packs/como-funcionan"
              variant="outlined"
              size="medium"
              sx={{
                borderColor: purple,
      ...
      <Container sx={{ py: 4 }} id="packs-pre-elaborados">
        <Typography variant="h4" textAlign="center" sx={{ mb: 1, color: purple, fontWeight: 800 }}>
          Packs pre elaborados
        </Typography>
        <Typography
          variant="body2"
          textAlign="center"
          sx={{ mb: 3, color: "#555", maxWidth: 640, mx: "auto" }}
        >
          Todo armado para ti con lo mejor de Ecopipo: lo esencial para empezar con confianza, sin
          complicarte la vida.
        </Typography>
                  ...
                  <CardContent>
                    ...
                    <Stack direction="row" alignItems="center" spacing={1} sx={{ mb: 2, flexWrap: "wrap" }}>
                      ...
                      <Typography sx={{ color: purple, fontWeight: 600 }}>
                        ...
                        {pack.priceDiscounted.toLocaleString("es-MX")}
                      </Typography>
                    </Stack>
                    <Button
                      variant="contained"
        ...
        <Typography variant="h6" sx={{ fontWeight: 600, mt: 3, textAlign: "center" }}>
          ¿Tienes dudas? Envía un mensaje a nuestro WhatsApp{" "}
          <Link href="https://wa.me/5215545485352" style={{ color: green }} target="_blank">
            CLICK AQUÍ
          </Link>
        </Typography>
